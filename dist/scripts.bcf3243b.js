...
var setupUI = function setupUI(user) {
  if (user) {
    ...
    // hide account info
    accountDetails.innerHTML = ""; // toggle UI elements
...
var setupGuides = function setupGuides(data) {
  if (data.length) {
    var html = "";
    data.forEach(function (doc) {
      var guide = doc.data();
      var li = "\n    <li>\n    <div class=\"collapsible-header grey lighten-4\">".concat(guide.title, "</div>\n    <div class=\"collapsible-body white\">\n    ").concat(guide.content, "\n    </div>\n    </li>\n    ");
      html += li;
    });
    guideList.innerHTML = html;
  } else {
    guideList.innerHTML = "<a\n    href=\"#\"\n    style=\"font-size:20px\"\n    class=\"red-text modal-trigger\"\n    data-target=\"modal-login\">Login</a> to see the detail";
  }
};
